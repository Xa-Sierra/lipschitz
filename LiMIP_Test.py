...
to=np.random.rand(x.shape[0])*3.14  # solo para senoidal vectorial, en senoidal colocar 1


dim = len(x)
dimh=np.load('dimo.npy') #colocar el numero de neuronas ocultas de la XOR
